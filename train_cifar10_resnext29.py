...
csv_logger = CSV_Logger('train_cifar10_resnext29.log', append=True)
...
# csv_logger = CSV_Logger('train_cifar10_resnext29.log')
...
model.save('cifar10-resnext29.h5')
...
plt.savefig('cifar10-resnext29-acc.png')
...
plt.xlabel('epoch')
plt.legend(['train', 'val'], loc='upper left')
plt.savefig('cifar10-resnext29-loss.png')
