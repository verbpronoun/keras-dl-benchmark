...
csv_logger = CSV_Logger('train3_cifar10_resnet18.log', append=True)
callbacks_list = [lr_reducer, csv_logger]
...
model.save('cifar10-resnet18-v3.h5')
...
plt.savefig('cifar10-resnet18-v3-acc.png')
...
plt.xlabel('epoch')
plt.legend(['train', 'val'], loc='upper left')
plt.savefig('cifar10-resnet18-v3-loss.png')
